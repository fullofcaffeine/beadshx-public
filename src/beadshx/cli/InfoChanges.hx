...
/** One pinned, typed copy of the upstream agent-relevant change history. */
typedef VersionChange = {
	final version:String;
	final date:String;
	final changes:Array<String>;
}

final class InfoChanges {
	public static final currentVersion = "1.2.1";
	public static final recent:Array<VersionChange> = [
		{
			version: "1.2.1",
			date: "2026-08-11",
			changes: [
